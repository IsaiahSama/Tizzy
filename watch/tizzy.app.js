...
let messageMenu = {
	...
	"You ate?": () => sendTempoMessage("You ate?"),
	"Okay!": () => sendTempoMessage("Okay!"),
	"No you!": () => sendTempoMessage("No you!"),
	"Hungy...": () => sendTempoMessage("Hungy..."),
	"NOMS!": () => sendTempoMessage("NOMS!"),
	"Sleepy...": () => sendTempoMessage("Sleepy..."),
	"Ni ni": () => sendTempoMessage("Ni ni"),
