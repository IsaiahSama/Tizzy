    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            val views = RemoteViews(context.packageName, R.layout.timer_widget).apply {
                ...
                setTextViewText(R.id.timer_title, title ?: "No title set")

                val duration = widgetData.getString("timer_duration", null)
                setTextViewText(R.id.timer_duration, duration ?: "No duration set")
            }
